...
import { showQuestionOverlay } from './overlays/question-icon-overlay.js';
import { showTrophyOverlay } from './overlays/trophy-icon-overlay.js';
...
document.body.addEventListener('keydown', (event) => {
    ...
    if (event.key === ' ') { resetScore(); }
    if (event.key === 'Enter') { autoPlay(); }
    if (event.key === 'q') { showQuestionOverlay(); }
    if (event.key === 't') { showTrophyOverlay(); }
